            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
                    ...
                    <section class="admins-add">
                        <form action="{{ route('our-services.store') }}" method="POST" class="form-validate"
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab"
                                            ...
                                            @endphp
                                            @if ($website_lang == 'ar')
                                                @include('Admin.OurServices.Create.create_form_ar')
                                            @elseif ($website_lang == 'en')
                                                @include('Admin.OurServices.Create.create_form_en')
                                            @elseif ($website_lang == 'both')
                                                @include('Admin.OurServices.Create.create_form_both')
                                            @endif
                                            <hr>
