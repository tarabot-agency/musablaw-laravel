                        ...
                        <div class="breadcrumbs-top">
                            ...
                            <div class="breadcrumb-wrapper d-none d-sm-block">
                                <ol class="breadcrumb p-0 mb-0 pl-1">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('app.parteners') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row" id="table-head">
                        <div class="col-12">
                                            ...
                                            <tbody>
                                                @foreach ($parteners as $partener)
                                                    <tr>
                                                        ...
                                                        <td class="text-bold-500">{{ $partener->name }}</td>
                                                        <td class="text-bold-500 ">
                                                            <img class="bg-dark" src="{{ asset('images/parteners/' . $partener->image) }}" width="50" />
                                                        </td>
                                                        <td>
                                                            <form id="deleteForm{{ $partener->id }}"
                                                                style="display: inline"
                                                                action="{{ route('partener.delete', $partener->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <a onclick="deletePartener({{ $partener->id }})"><i
                            ...
                            <div class="card-footer">
                                {{ $parteners->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
