        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
                    ...
                    <section class="experience-edit">
                        <div class="card">
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active fade show" id="account" aria-labelledby="account-tab"
                                        role="tabpanel">
                                        <form action="{{ route('experience.store') }}" method="POST" class="form-validate"
                                        ...
                                        <!-- experience edit account form ends -->
                                    </div>
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- experience edit ends -->
                </div>
                </section>
                <!-- experience edit ends -->
            </div>
